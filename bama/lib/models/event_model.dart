 ...
 static List<Event> getFakeEvents() {
  return [
    Event(
      ...
      ticketTypes: [
        TicketType(type: 'Standard', price: 10000, available: 200),
        TicketType(type: 'VIP', price: 20000, available: 50),
      ],
    ),
    Event(
      id: '2',
      ...
      ticketTypes: [
        TicketType(type: 'Pass Jour', price: 5000, available: 300),
        TicketType(type: 'Pass 3 Jours', price: 12000, available: 100),
      ],
    ),
    Event(
      id: '3',
      ...
      ticketTypes: [
        TicketType(type: 'Tribune', price: 3000, available: 500),
        TicketType(type: 'VIP', price: 10000, available: 100),
      ],
    ),
    Event(
      id: '4',
      ...
      ticketTypes: [
        TicketType(type: 'Solo', price: 15000, available: 100),
        TicketType(type: 'Couple', price: 25000, available: 50),
      ],
    ),
    Event(
      id: '5',
      ...
      ticketTypes: [
        TicketType(type: 'Normal', price: 2000, available: 150),
        TicketType(type: 'VIP', price: 5000, available: 30),
      ],
    ),
    Event(
      id: '6',
      ...
      ticketTypes: [
        TicketType(type: 'Standard', price: 7000, available: 200),
        TicketType(type: 'VIP', price: 12000, available: 40),
      ],
    ),
    Event(
      id: '7',
      ...
      ticketTypes: [
        TicketType(type: 'Entrée Simple', price: 1000, available: 1000),
      ],
    ),
    Event(
      id: '8',
      ...
      ticketTypes: [
        TicketType(type: 'Entrée Libre', price: 0, available: 9999),
      ],
    ),
    Event(
      id: '9',
      ...
      ticketTypes: [
        TicketType(type: 'Pack Standard', price: 25000, available: 40),
        TicketType(type: 'Pack VIP', price: 40000, available: 20),
      ],
    ),
  ];
}
...
class TicketType {
  ...
  Map<String, dynamic> toJon() {
    return {'type': type, 'price': price, 'available': available};
  }
}
